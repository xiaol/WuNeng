...
## Sequential state learning-rate sweep
...
- `outputs/benchmarks/ple256-bf16-pre-then-state-lr1e-3-scene-e1-all149.json`
- `outputs/benchmarks/ple256-bf16-pre-then-state-lr3e-3-scene-e1-all149.json`
